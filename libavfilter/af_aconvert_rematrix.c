...
/**
 * This is for when we have more than 2 inpput channels, need to downmix to mono
 * and do not have a conversion formula available.  We just use first two inpput
